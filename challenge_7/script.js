...
function showJoke() {
  ...
  jokeText.textContent = randomJokeText;
  clearAll();
...
function showQuote() {
  ...
  clearAll();
  container.appendChild(quoteText).appendChild(quoteAuthor);
}
...
function revealAnswers() {
  ...
  } else if (riddleAnswer && !riddleAnswer.hidden) {
    window.alert("The answer is already shown.");
  } else {
    window.alert("There is no riddle to answer.");
  }
}
